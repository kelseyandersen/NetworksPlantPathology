...
Use igraph "graph" function to plot a network directly as igraph object. 
```{r}
...
Nodelist <- data.frame(
                    ...
                    YearsFarming = c(8.5, 6.5, 4, 1, 3, 10, 5, 5, 5, 1, 1, 6, 6) , 
                    Age = c(22, 31, 25, 21, 22, 35, 42, 27, 26, 33, 26, 28, 22) , 
                    Gender = c("Male", "Female", "Male", "Female", "Female", "Male","Male","Male", "Female", "Male", "Female", "Male"))
Edgelist <- data.frame(
                  From = c("Jim", "Jim", "Jim", "Jill", "Kate", "Pete", "Pete", "Jess", "Jim", "Jim", "Pete"),
                  To = c("Carole", "Jen", "Pete", "Carole", "Joe", "Carole", "Paul", "Mark", "Cam", "Mark", "Tim")

AsMatrix <- graph_from_data_frame(d = Edgelist, vertices = Nodelist, directed = FALSE)
plot(AsMatrix)
